...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pgcli-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pgcli-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `pgcli` available on your platform:
...
```
pixi search pgcli --channel conda-forge
```
